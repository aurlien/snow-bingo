...
`;const d=document.querySelector(".card"),i=t=>{const n=`
  ...
  `;c?(d.innerHTML=`
      <img src=${y} />
    `,setTimeout(()=>{c=!1,d.innerHTML=n},u)):d.innerHTML=n},p=()=>{o<s.length-1&&(c=!0,i(s[++o]))},f=()=>{o>0&&i(s[--o])};document.addEventListener("keydown",function(t){console.log(t.key);const n={ArrowLeft:()=>f(),ArrowRight:()=>p()}[t.key];n==null||n()});i(s[0]);
